...
class Jewellers extends StatefulWidget {
  @override
  _JewellersState createState() => _JewellersState();
}

class _JewellersState extends State<Jewellers> {
  Future<List<DataTypeTwo>> getData() async {
    var data = await http.get('http://app.irabwah.com/app_data/flutter/jewellers.json');
